...
export class FooterComponent {
  ...
  serviceLinks = [
    { label: 'Levantamento Topográfico', href: '#servicos' },
    { label: 'Georreferenciamento', href: '#servicos' },
    { label: 'Aerofotogrametria', href: '#servicos' },
    { label: 'Topografia para Obras', href: '#servicos' },
    { label: 'Regularização de Imóvel', href: '#servicos' },
  ];
